    ...
    private void initListeners() {
        ...
        BecomeASellerListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new SettingMemoryData(Seller.ActivitySetting.this).setSharedPrefString(String.valueOf(R.string.account_type_key), "user");

                Utils.ActivityNavigation.openUserActivity(ActivitySetting.this, "user");
