...
import FirebaseConnectivity.UserDataHandler;

import static com.selflearn.alwarrenter.R.drawable.certified_icon2;
...
public class CustomDialogMaker {
    ...
    public void createAndShowDialogSuccess(String message , final String ActivityName )
    {
      ...
      Success_view.setImageDrawable(activity.getDrawable(certified_icon2));
      ...
      builder.setTitle("Success").setMessage(message).setPositiveButton("Done", new DialogInterface.OnClickListener() {
          ...
          public void onClick(DialogInterface dialog, int which) {
             dialog.dismiss();
//              activity.finish();
              if(ActivityName.equals("seller"))
              Utils.ActivityNavigation.startSellerDashBoard(activity,"seller");
              else  if(ActivityName.equals("user"))
                  Utils.ActivityNavigation.openUserActivity(activity,ActivityName);
